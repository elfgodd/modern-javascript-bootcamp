...
console.log(mySong); // "Xurfing the USA"
...
// "leave me alone plz" removes white spaces at the beginning and at the end  
greeting.trim()
...
// "hee ha ha" it only replaces the first one

'ha ha ha'.replace('haaaa', 'heee); // SyntaxError: it won't find it, so it won't replace it
...
`I conted { 3 + 4 } sheeps`; // This is in ReactJS JSX
...
Math.pow(5,5) // 3125 Raises 5 to the 5th power  
...
const step2 = step1 X 10 // 5.961104892810127  
const step3 = Math.floor(step2); // 5  
// If i don't add 1 it will give me sometimes 0 zero number  
const step4 = step3 + 1;
